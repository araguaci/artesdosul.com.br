...
Em [horizonte.artesdosul.com](https://horizonte.artesdosul.com/) não há só uma landing. Há um **framework estratégico 2026–2027** publicado como produto: aplicações interativas, dezenas de documentos em Markdown abertos no browser, outputs de ciclo em JSON para automação e um mapa de **transição para soberania digital, computacional e financeira** — com meta explícita para março de 2027.
...
- *Eventos Críticos* — **60 eventos em 6 camadas**, nexos e cenários preditivos.
...
1. Abrir o [hub](https://horizonte.artesdosul.com/) e marcar 5 artefatos no contador.
...
- Hub: [Sistema Horizonte — Hub do Projeto](https://horizonte.artesdosul.com/)
- Centro de Comando: [centro-comando.html](https://horizonte.artesdosul.com/centro-comando.html)
